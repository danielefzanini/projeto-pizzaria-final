...
router.delete('/deleteitemorder', isAuthenticated, new RemoveItemController().handle);

//------Envio do pedido com mudança do status do rascunho para false -----//
router.post('/updateorder', isAuthenticated, new  UpdateOrderController().handle);

//------lista dos pedidos por data e hora-----//
router.get('/listorder', isAuthenticated, new ListOrderController().handle);

//------detalhes do pedido-----//
router.post('/detailsorder', isAuthenticated, new DetailsOrderController().handle);

//------finalização do pedido, com cálculo do total a pagar -----//
router.post('/finalizedorder', isAuthenticated, new FinalizedOrderController().handle);
